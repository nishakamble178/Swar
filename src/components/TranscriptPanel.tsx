...
const SENTENCE_GUIDE: { gesture: string; sentence: string }[] = [
  ...
  { gesture: "Sign letter G", sentence: "Good Morning" },
  { gesture: "Sign letter E", sentence: "Good Evening" },
  { gesture: "Sign letter H", sentence: "How are you?" },
  { gesture: "Sign letter F", sentence: "I am Fine" },
  { gesture: "Sign letter Y", sentence: "Thank You" },
  ...
  { gesture: "Sign letter U", sentence: "I Understand" },
