...
const SENTENCE_GUIDE: { gesture: string; sentence: string }[] = [
  ...
  { gesture: "👌 OK", sentence: "I Understand" },
  ...
  { gesture: "Sign letter A (fist, thumb on side)", sentence: "Sorry" },
  { gesture: "Sign letter B (flat hand, thumb across)", sentence: "Please" },
  { gesture: "Sign letter C (curved hand)", sentence: "Good Evening" },
  { gesture: "Sign letter D (index up, thumb-middle pinch)", sentence: "Good Morning" },
  { gesture: "Sign letter I (pinky only)", sentence: "I Am Thirsty" },
  { gesture: "Sign letter L (thumb + index L-shape)", sentence: "Thank You" },
  { gesture: "Sign letter W (3 fingers up)", sentence: "I Need Water" },
  { gesture: "Sign letter Y (thumb + pinky out)", sentence: "I am Fine" },
  { gesture: "Number 3 (thumb + index + middle)", sentence: "How are you?" },
  { gesture: "Number 4 (4 fingers, thumb folded)", sentence: "I Don't Understand" },
  { gesture: "Number 5 (all 5 fingers up)", sentence: "Can you explain?" },
  { gesture: "Number 6 (pinky touches thumb)", sentence: "What is today's class?" },
  { gesture: "Number 7 (ring touches thumb)", sentence: "I have homework" },
  { gesture: "Number 8 (middle touches thumb)", sentence: "Please repeat" },
  { gesture: "Number 9 (index touches thumb)", sentence: "I have a question" },
  { gesture: "Sign letter G (horizontal index)", sentence: "Thank you teacher" },
  { gesture: "Sign letter T (fist, thumb between index/middle)", sentence: "Where is classroom?" },
  { gesture: "Sign letter H (horizontal 2 fingers)", sentence: "I am late" },
];
